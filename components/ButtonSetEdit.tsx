...
export interface ButtonSetEditProps extends DefaultButtonSetEditProps {}

function ButtonSetEdit_(
  props: ButtonSetEditProps,
  ...
  return <PlasmicButtonSetEdit root={{ ref }} {...props} />;
}

const ButtonSetEdit = React.forwardRef(ButtonSetEdit_);

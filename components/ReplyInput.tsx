...
export interface ReplyInputProps extends DefaultReplyInputProps {}

function ReplyInput_(props: ReplyInputProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicReplyInput root={{ ref }} {...props} />;
}

const ReplyInput = React.forwardRef(ReplyInput_);

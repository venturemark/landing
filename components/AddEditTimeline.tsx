...
export interface AddEditTimelineProps extends DefaultAddEditTimelineProps {}

function AddEditTimeline_(
  props: AddEditTimelineProps,
  ...
  return <PlasmicAddEditTimeline settings={{ ref }} {...props} />;
}

const AddEditTimeline = React.forwardRef(AddEditTimeline_);

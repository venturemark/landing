...
import { PlasmicModal, DefaultModalProps } from "./plasmic/shared/PlasmicModal";
...
function Modal_(props: ModalProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicModal root={{ ref }} {...props} />;
}

const Modal = React.forwardRef(Modal_);

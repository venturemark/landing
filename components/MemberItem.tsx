...
} from "./plasmic/shared/PlasmicMemberItem";
...
export interface MemberItemProps extends DefaultMemberItemProps {}

function MemberItem_(props: MemberItemProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicMemberItem root={{ ref }} {...props} />;
}

const MemberItem = React.forwardRef(MemberItem_);

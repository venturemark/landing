...
export const defaultPostDetails__Args: Partial<PlasmicPostDetails__ArgsType> =
  {};
...
function PlasmicPostDetails__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultPostDetails__Args, props.args);
  const $props = args;
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__qVw1C)}>
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__qxUjW)}>
            {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__n7A9B)}>
          <ContentPost
...
const PlasmicDescendants = {
  ...
  replyContent: ["replyContent", "userName2", "date2", "textContainer2"],
  userName2: ["userName2"],
  date2: ["date2"],

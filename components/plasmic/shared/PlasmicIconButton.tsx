...
export const defaultIconButton__Args: Partial<PlasmicIconButton__ArgsType> = {};
...
function PlasmicIconButton__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultIconButton__Args, props.args);
  const $props = args;
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <IconFeedIcon
              className={classNames(projectcss.all, sty.svg__toCuH)}
              role={"img"}
            />
          ),

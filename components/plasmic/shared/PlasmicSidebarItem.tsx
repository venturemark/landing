...
export const defaultSidebarItem__Args: Partial<PlasmicSidebarItem__ArgsType> =
  {};
...
function PlasmicSidebarItem__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultSidebarItem__Args, props.args);
  const $props = args;
  ...
  return (
    ...
    >
      {(
        ...
        <IconOvalIcon
          className={classNames(projectcss.all, sty.svg__bufRg, {
            [sty.svghasNewActivity__bufRg0PiUm]: hasVariant(
              variants,
              "hasNewActivity",
              "hasNewActivity"
            ),
      ...
      {(
        ...
        <p.Stack
          ...
          className={classNames(projectcss.all, sty.itemContainer, {
            ...
            [sty.itemContainerisVisible_itemType_createTimeline]:
              hasVariant(variants, "itemType", "createTimeline") &&
            ...
            [sty.itemContaineritemType_createTimeline_isActive]:
          ...
          {(
            ...
            <IconButton
              ...
              className={classNames("__wab_instance", sty.icon, {
                ...
                [sty.iconitemType_createTimeline_isActive]:
                  hasVariant(variants, "isActive", "isActive") &&
                  hasVariant(variants, "itemType", "createTimeline"),
              ...
              {(
                ...
                <IconButton
                  ...
                  className={classNames("__wab_instance", sty.iconButton, {
                    ...
                    [sty.iconButtonitemType_createTimeline_isActive]:
                      hasVariant(variants, "isActive", "isActive") &&
                      hasVariant(variants, "itemType", "createTimeline"),
                ...
                >
                  <IconDotMenuIcon
                    className={classNames(projectcss.all, sty.svg__zhtWc, {
                      ...
                      [sty.svgisOwner_isActive__zhtWcXgVg8W0Xu8]:
                        hasVariant(variants, "isActive", "isActive") &&
                        hasVariant(variants, "isOwner", "isOwner"),
                      [sty.svgitemType_createTimeline_isActive__zhtWcOuGstW0Xu8]:
                        hasVariant(variants, "isActive", "isActive") &&
                        hasVariant(variants, "itemType", "createTimeline"),
                    })}
                    role={"img"}
          ...
          {(
            ...
            <Dropdown
              ...
              className={classNames("__wab_instance", sty.dropdown, {
                ...
                [sty.dropdownisOwner_isDropdown]:
                  hasVariant(variants, "isDropdown", "isDropdown") &&
                  hasVariant(variants, "isOwner", "isOwner"),
              ...
              rename2={
                <div
                  data-plasmic-name={"editLink"}
                  data-plasmic-override={overrides.editLink}
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
                    sty.editLink,
                    {
                      [sty.editLinkisOwner]: hasVariant(
                        variants,
                        "isOwner",
                        "isOwner"
                      ),
                      [sty.editLinkisOwner_itemType_timeline]:
                        hasVariant(variants, "isOwner", "isOwner") &&
                        hasVariant(variants, "itemType", "timeline"),
                      [sty.editLinkitemType_timeline]: hasVariant(
                        variants,
                        "itemType",
                        "timeline"
                      ),
...
const PlasmicDescendants = {
  root: ["root", "itemContainer", "icon", "iconButton", "dropdown", "editLink"],
  itemContainer: [
    "itemContainer",
    "icon",
    "iconButton",
...
export const PlasmicSidebarItem = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    editLink: makeNodeComponent("editLink"),

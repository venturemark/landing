...
export const defaultIconButtonMember__Args: Partial<PlasmicIconButtonMember__ArgsType> =
  {};
...
function PlasmicIconButtonMember__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultIconButtonMember__Args, props.args);
  const $props = args;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__ysBge)}>
            {p.renderPlasmicSlot({
              defaultContents: "+",

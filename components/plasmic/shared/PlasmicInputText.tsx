...
export const defaultInputText__Args: Partial<PlasmicInputText__ArgsType> = {};
...
function PlasmicInputText__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultInputText__Args, props.args);
  const $props = args;
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9LrSw)}>
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__lygyM)}>
              <div className={classNames(projectcss.all, sty.freeBox__eDsPg)}>
                <input

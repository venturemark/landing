...
export const defaultButtonSetEdit__Args: Partial<PlasmicButtonSetEdit__ArgsType> =
  {};
...
function PlasmicButtonSetEdit__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultButtonSetEdit__Args, props.args);
  const $props = args;
...
const PlasmicDescendants = {
  ...
  _delete: ["_delete", "text32", "text222"],
  text32: ["text32"],
  text222: ["text222"],
  cancel: ["cancel", "text3", "text22"],
  text3: ["text3"],
  text22: ["text22"],
  save: ["save", "text", "text2"],
  text: ["text"],
  text2: ["text2"],
} as const;

...
import MemberItem from "../../MemberItem"; // plasmic-import: D8Y_2wee1o/component
...
export const defaultAddEditMembers__Args: Partial<PlasmicAddEditMembers__ArgsType> =
  {};
...
function PlasmicAddEditMembers__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultAddEditMembers__Args, props.args);
  const $props = args;
  ...
  return (
    ...
    >
      ...
      {(hasVariant(variants, "isOwner", "isOwner") ? true : false) ? (
        ...
        >
          ...
          {(hasVariant(variants, "type", "isTimeline") ? false : false) ? (
            ...
            >
              <IconLinkIcon
                className={classNames(projectcss.all, sty.svg__opzJ7)}
                role={"img"}
              />
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yRlj0)}>
        <div className={classNames(projectcss.all, sty.freeBox__guHgU)}>
          {p.renderPlasmicSlot({
      ...
      {false ? (
        <div className={classNames(projectcss.all, sty.freeBox___1CNd9)}>
          <Button
            ...
            slot={
              <IconPlusIcon
                className={classNames(projectcss.all, sty.svg__qlkG3)}
                role={"img"}
              />
            }
            text2={
          ...
          >
            <IconRightIcon
              className={classNames(projectcss.all, sty.svg__zn1XH)}
              role={"img"}
            />
          </Button>
        </div>
...
const PlasmicDescendants = {
  ...
  form: ["form", "email", "invite", "text3", "text22"],
  email: ["email"],
  invite: ["invite", "text3", "text22"],
  text3: ["text3"],
  text22: ["text22"],
  link: ["link", "span"],
  span: ["span"],
  membersContainer: ["membersContainer"],
  button: ["button", "text", "text2"],
  text: ["text"],
  text2: ["text2"],
} as const;

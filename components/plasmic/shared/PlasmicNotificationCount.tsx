...
export const defaultNotificationCount__Args: Partial<PlasmicNotificationCount__ArgsType> =
  {};
...
function PlasmicNotificationCount__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultNotificationCount__Args, props.args);
  const $props = args;

...
import { PlasmicTags, DefaultTagsProps } from "./plasmic/shared/PlasmicTags";
...
export interface TagsProps extends DefaultTagsProps {}

function Tags_(props: TagsProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicTags root={{ ref }} {...props} />;
}

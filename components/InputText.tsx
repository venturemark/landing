...
} from "./plasmic/shared/PlasmicInputText";
...
function InputText_(props: InputTextProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicInputText root={{ ref }} {...props} />;
}

const InputText = React.forwardRef(InputText_);

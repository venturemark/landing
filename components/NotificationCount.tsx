...
} from "./plasmic/shared/PlasmicNotificationCount";
...
export interface NotificationCountProps extends DefaultNotificationCountProps {}

function NotificationCount_(
  props: NotificationCountProps,
  ...
  return <PlasmicNotificationCount root={{ ref }} {...props} />;
}

const NotificationCount = React.forwardRef(NotificationCount_);

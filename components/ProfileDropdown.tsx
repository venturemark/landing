...
} from "./plasmic/shared/PlasmicProfileDropdown";
...
export interface ProfileDropdownProps extends DefaultProfileDropdownProps {}

function ProfileDropdown_(
  ...
  return <PlasmicProfileDropdown root={{ ref }} {...props} />;
}

const ProfileDropdown = React.forwardRef(ProfileDropdown_);
